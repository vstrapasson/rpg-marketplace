...
export const ENTITIES = {
  ...
  item: { folder: 'itens', required: ['type'],
    fields: { value: { type: 'number' }, item_level: { type: 'number' },
      rarity: { type: 'enum', values: ['common', 'uncommon', 'rare', 'unique'] },
      category: { type: 'enum', values: ['permanent', 'consumable', 'currency', 'art', 'gear'] } },
